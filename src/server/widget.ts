  ...
  return `
    <style>
      * { box-sizing: border-box; }
      :root { color: #17201b; background: #f7f8f4; font-family: system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; }
      body { margin: 0; background: #f7f8f4; }
      main { min-height: 360px; max-width: 980px; margin: 0 auto; padding: 24px; background: #f7f8f4; }
      .eyebrow { margin: 0 0 8px; color: #51685a; font-size: 12px; font-weight: 700; letter-spacing: 0; text-transform: uppercase; }
      h1 { margin: 0 0 14px; color: #17201b; font-size: 30px; line-height: 1.08; }
      h2 { margin: 0 0 10px; color: #17201b; font-size: 17px; line-height: 1.2; }
    ...
    <main id="root" aria-label="ProposalCraft AI widget">
